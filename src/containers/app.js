    ...
    return (
      <div className={'container'}>
        <section className={'col-sm-12 text-center container'} style={{ color: '#999' }}>
          ...
          <div
            className={'col-sm-6 col-sm-offset-6 shadow'}
            style={{ margin: '0px auto', left: '50%', transform: 'translate(-50%, 0)', background: 'rgba(13,8,42,1)',
              borderRadius: '6px', padding: '8px', position: 'fixed', bottom: '0px', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px'
            }}
          >
